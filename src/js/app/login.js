...
var Shadow = __webpack_require__(36);
...
mf.comp.Frame = function (_mf$Component) {
    ...
    function _class(x_opt, y) {
        ...
        try {
            ...
            _this.name('Frame');
            _this.prmOpt('number' === typeof x_opt ? { param: [x_opt, y] } : x_opt);
        } catch (e) {
            console.error(e.stack);
            throw e;
        }
...
var Fade = __webpack_require__(44);
/* util */
var Font = __webpack_require__(45);
/* app ctrl */
var theme = __webpack_require__(46);

var start_btn = function start_btn() {
    return new Button({
        height: 33,
...
var LoginForm = __webpack_require__(37);
/* event */
var Click = __webpack_require__(2);
/* effect */
...
var Text = __webpack_require__(1);
var Click = __webpack_require__(2);
var Horizon = __webpack_require__(6);
 ...
 */
mofron.comp.Image = function (_mofron$Component) {
 ...
 * @author simpart
 */
mofron.font.Google = function (_mofron$Font) {
    _inherits(_class, _mofron$Font);

    function _class(fnt, pth) {
        _classCallCheck(this, _class);

        try {
            var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, fnt, pth));
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["app"] = __webpack_require__(48);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
